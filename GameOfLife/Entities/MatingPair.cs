...
{
    /// <summary>A class to form mating pairs for T animals.</summary>
    /// <typeparam name="T">The type of objects that can form mating pairs.</typeparam>
    public class MatingPair<T> where T : ISimulable
    {
        /// <summary>The first member of the mating pair.</summary>
        public T MatingPair1 { get; init; }

        /// <summary>The second member of the mating pair.</summary>
        public T MatingPair2 { get; init; }

        /// <summary>Initializes a new instance of the MatingPair class with the provided mating pair members.</summary>
